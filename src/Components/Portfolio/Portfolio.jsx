  ...
  return (
    <>
      <section className="portfolio-section">
          ...
          <div className="container">
            <div className="row g-5">
              <div className="col-md-4">
                <div className="img-wrapper rounded-3 overflow-hidden position-relative" onClick={(e)=>{showImage(e)}}>
        ...
        <div className="img-popup position-fixed top-0 bottom-0 start-0 end-0 bg-primary bg-opacity-25" onClick={(e)=>{hideImage(e)}}>
          <div className="row h-100 align-content-center justify-content-center">
            <div className="col-md-5">
              <img alt="..." className="w-100 d-block" src={port1}/>
            </div>
          </div>
        </div>
      </section>
